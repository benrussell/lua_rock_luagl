...
{
  glArrayElement((GLint)luaL_checkinteger(L, 1));
  return 0;
}
...
{
  glBindTexture(luagl_get_gl_enum(L, 1), (GLuint)luaL_checkinteger(L, 2));
  return 0;
}
...
{
  glBitmap((GLsizei)luaL_checkinteger(L, 1), (GLsizei)luaL_checkinteger(L, 2), (GLfloat)luaL_checknumber(L, 3),
...
/*BlendFuncSeparate (srcRGB, dstRGB, srcAlpha, dstAlpha) -> none*/
//This failes to link on windows.
/*
static int luagl_blend_func_separate(lua_State *L)
{
  glBlendFuncSeparate(luagl_get_gl_enum(L, 1), luagl_get_gl_enum(L, 2), luagl_get_gl_enum(L, 3), luagl_get_gl_enum(L, 4));
  return 0;
}
*/
...
{
  glClearStencil((GLint)luaL_checkinteger(L, 1));
  return 0;
}
...
static int luagl_color_pointer(lua_State *L)
{
  ...
  if (lua_isnumber(L, 2))
  {
    size = (GLint)luaL_checkinteger(L, 2);
...
{
  glCopyPixels((GLint)luaL_checkinteger(L, 1), (GLint)luaL_checkinteger(L, 2),
...
static int luagl_copy_tex_image(lua_State *L)
{
  ...
  if (num_args > 6)
  {
    glCopyTexImage2D(GL_TEXTURE_2D, (GLint)luaL_checkinteger(L, 1), luagl_get_gl_enum(L, 2),
		(GLint)luaL_checkinteger(L, 4), (GLint)luaL_checkinteger(L, 5),
		(GLsizei)luaL_checkinteger(L, 6), (GLsizei)luaL_checkinteger(L, 7),
		(GLint)luaL_checkinteger(L, 3));
  }
  else
  {
    glCopyTexImage1D(GL_TEXTURE_1D, (GLint)luaL_checkinteger(L, 1), luagl_get_gl_enum(L, 2),
		(GLint)luaL_checkinteger(L, 4), (GLint)luaL_checkinteger(L, 5),
		(GLsizei)luaL_checkinteger(L, 6), (GLint)luaL_checkinteger(L, 3));
  }
  return 0;
}
...
static int luagl_copy_tex_sub_image(lua_State *L)
{
  ...
  if (num_args >= 7)
  {
    glCopyTexSubImage2D(GL_TEXTURE_2D,
		(GLint)luaL_checkinteger(L, 1), (GLint)luaL_checkinteger(L, 4),
		(GLint)luaL_checkinteger(L, 6), (GLint)luaL_checkinteger(L, 2),
		(GLint)luaL_checkinteger(L, 3), (GLsizei)luaL_checkinteger(L, 5),
		(GLsizei)luaL_checkinteger(L, 7));
  }
  else
  {
    glCopyTexSubImage1D(GL_TEXTURE_1D,
		(GLint)luaL_checkinteger(L, 1), (GLint)luaL_checkinteger(L, 4),
		(GLint)luaL_checkinteger(L, 2), (GLint)luaL_checkinteger(L, 3),
		(GLsizei)luaL_checkinteger(L, 5));
  }
  return 0;
}
...
{
  glDeleteLists((GLuint)luaL_checkinteger(L, 1), (GLsizei)luaL_checkinteger(L, 2));
  return 0;
}
...
{
  glDrawArrays(luagl_get_gl_enum(L, 1), (GLint)luaL_checkinteger(L, 2), (GLsizei)luaL_checkinteger(L, 3));
  return 0;
}
...
static int luagl_draw_pixels(lua_State *L)
{
  ...
  glDrawPixels((GLsizei)luaL_checkinteger(L, 1), (GLsizei)luaL_checkinteger(L, 2),
...
static int luagl_eval_mesh(lua_State *L)
{
  int num_args = lua_gettop(L);
  if(num_args < 5)
    glEvalMesh1(luagl_get_gl_enum(L, 1), (GLint)luaL_checkinteger(L, 2), (GLint)luaL_checkinteger(L, 3));
  else
    glEvalMesh2(luagl_get_gl_enum(L, 1), (GLint)luaL_checkinteger(L, 2), (GLint)luaL_checkinteger(L, 3),
	  (GLint)luaL_checkinteger(L, 4), (GLint)luaL_checkinteger(L, 5));
  return 0;
}
...
static int luagl_eval_point(lua_State *L)
{
  int num_args = lua_gettop(L);
  if(num_args == 1)
    glEvalPoint1((GLint)luaL_checkinteger(L, 1));
  else
    glEvalPoint2((GLint)luaL_checkinteger(L, 1), (GLint)luaL_checkinteger(L, 2));
  return 0;
}
...
static int luagl_feedback_buffer(lua_State *L)
{
  ...
  size = (GLsizei)luaL_checkinteger(L, 1);
...
{
  lua_pushnumber(L, glGenLists((GLsizei)luaL_checkinteger(L, 1)) );
  return 1;
}
...
{
  glGetTexImage(luagl_get_gl_enum(L, 1), (GLint)luaL_checkinteger(L, 2), luagl_get_gl_enum(L, 3),
...
{
  GLfloat param;
  glGetTexLevelParameterfv(luagl_get_gl_enum(L, 1), (GLint)luaL_checkinteger(L, 2), luagl_get_gl_enum(L, 3), &param);
...
static int luagl_index_mask(lua_State *L)
{
  if(lua_type(L,1) == LUA_TSTRING)
    ...
    glIndexMask((GLuint)luaL_checkinteger(L, 1));
  return 0;
}
...
{
  lua_pushboolean(L, glIsList((GLuint)luaL_checkinteger(L, 1)));
  return 1;
}
...
{
  lua_pushboolean(L, glIsTexture((GLuint)luaL_checkinteger(L, 1)));
  return 1;
}
...
static int luagl_line_stipple(lua_State *L)
{
  if (lua_type(L,2) == LUA_TSTRING)
    glLineStipple((GLint)luaL_checkinteger(L, 1), (GLushort)luagl_str2mask(luaL_checkstring(L, 2)));
  else 
    glLineStipple((GLint)luaL_checkinteger(L, 1), (GLushort)luaL_checkinteger(L, 2));
  return 0;
}
...
{
  glListBase((GLuint)luaL_checkinteger(L, 1));
  return 0;
}
...
{
  glLoadName((GLuint)luaL_checkinteger(L, 1));
  return 0;
}
...
{
  if (lua_gettop(L) < 6)
    glMapGrid1d((GLint)luaL_checkinteger(L, 1),
                luaL_checknumber(L, 2),
                luaL_checknumber(L, 3));
  else
    glMapGrid2d((GLint)luaL_checkinteger(L, 1),
                luaL_checknumber(L, 2),
                luaL_checknumber(L, 3),
		(GLint)luaL_checkinteger(L, 4),
...
{
  glNewList((GLuint)luaL_checkinteger(L, 1), luagl_get_gl_enum(L, 2));
  return 0;
}
...
{
  glPushName((GLuint)luaL_checkinteger(L, 1));
  return 0;
}
...
static int luagl_read_pixels(lua_State *L)
{
  ...
  glReadPixels((GLint)luaL_checkinteger(L, 1), (GLint)luaL_checkinteger(L, 2),
...
{
  glScissor((GLint)luaL_checkinteger(L, 1), (GLint)luaL_checkinteger(L, 2), (GLsizei)luaL_checkinteger(L, 3), (GLsizei)luaL_checkinteger(L, 4));
  return 0;
}
...
static int luagl_stencil_func(lua_State *L)
{
  if (lua_type(L,3) == LUA_TSTRING)
    glStencilFunc(luagl_get_gl_enum(L, 1), (GLint)luaL_checkinteger(L, 2), luagl_str2mask(luaL_checkstring(L, 3)));
  else 
    glStencilFunc(luagl_get_gl_enum(L, 1), (GLint)luaL_checkinteger(L, 2), (GLuint)luaL_checkinteger(L, 3));
  return 0;
}
...
static int luagl_stencil_mask(lua_State *L)
{
  if(lua_type(L,1) == LUA_TSTRING)
    ...
    glStencilMask((GLuint)luaL_checkinteger(L, 1));
  return 0;
}
...
static int luagl_tex_image(lua_State *L)
{
  ...
  if(lua_isnumber(L, 1) && lua_istable(L, 2))
  {
    ...
    iformat = (GLint)luaL_checkinteger(L, -1);
    lua_remove(L, -1);
  ...
  else
  {
    ...
    iformat = (GLint)luaL_checkinteger(L, 2);
    index = 4;
  }
  ...
  if (height != -1)
  {
    glTexImage2D(GL_TEXTURE_2D, (GLint)luaL_checkinteger(L, 1),
		(GLint)iformat, width/iformat, height, 0, e, GL_UNSIGNED_BYTE, pixels);
  }
  else  /* if not 2D, get 1D */
  {
    width = luagl_get_arrayuc(L, index, &pixels);
    glTexImage1D(GL_TEXTURE_1D, (GLint)luaL_checkinteger(L, 1),
		(GLint)iformat, width/iformat, 0, e, GL_UNSIGNED_BYTE, pixels);
  }
  LUAGL_DELETE_ARRAY(pixels);
  return 0;
}
...
{
  glTexImage2D(GL_TEXTURE_2D, (GLint)luaL_checkinteger(L, 1),
	  (GLint)luaL_checkinteger(L, 2), (GLsizei)luaL_checkinteger(L, 3),
              (GLsizei)luaL_checkinteger(L, 4), (GLint)luaL_checkinteger(L, 5),
...
static int luagl_tex_image_1d(lua_State *L)
{
  glTexImage1D(GL_TEXTURE_1D, (GLint)luaL_checkinteger(L, 1),
	  (GLint)luaL_checkinteger(L, 2), (GLsizei)luaL_checkinteger(L, 3),
	  (GLint)luaL_checkinteger(L, 4), luagl_get_gl_enum(L, 5),
...
static int luagl_tex_sub_image(lua_State *L)
{
  ...
  if(height != -1)
  {
    glTexSubImage2D(GL_TEXTURE_2D, (GLint)luaL_checkinteger(L, 1), (GLint)luaL_checkinteger(L, 4),
		(GLint)luaL_checkinteger(L, 5), width/depth, height, format, GL_FLOAT, pixels);
  }
  else  /* if not 2D, get 1D */
  {
    width = luagl_get_arrayf(L, 3, &pixels);
    glTexSubImage1D(GL_TEXTURE_1D, (GLint)luaL_checkinteger(L, 1), (GLint)luaL_checkinteger(L, 4),
...
{
  glTexSubImage2D(GL_TEXTURE_2D, (GLint)luaL_checkinteger(L, 1), (GLint)luaL_checkinteger(L, 2),
	  (GLint)luaL_checkinteger(L, 3), (GLsizei)luaL_checkinteger(L, 4), (GLsizei)luaL_checkinteger(L, 5),
                  luagl_get_gl_enum(L, 6), luagl_get_gl_enum(L, 7), luagl_checkuserdata(L, 8));
  return 0;
}
...
{
  glTexSubImage1D(GL_TEXTURE_1D, (GLint)luaL_checkinteger(L, 1), (GLint)luaL_checkinteger(L, 2),
	  (GLsizei)luaL_checkinteger(L, 3), luagl_get_gl_enum(L, 4),
...
static const luaL_Reg luagl_lib[] = {
  ...
  //{"BlendFuncSeparate", luagl_blend_func_separate}, //doesn't link on windows.
